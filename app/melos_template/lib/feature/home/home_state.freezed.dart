...
class _$HomeStateImpl implements _HomeState {
  const _$HomeStateImpl({required this.isInternetConnected});
  ...
  @override
  String toString() {
    return 'HomeState(isInternetConnected: $isInternetConnected)';
  }
...
abstract class _HomeState implements HomeState {
  const factory _HomeState({required final bool isInternetConnected}) =
      _$HomeStateImpl;
